...
from fairseq.modules import (
    ...
    TransformerDecoderLayerBN,
    TransformerEncoderLayerBN,
)
...
@register_model('transformer_bn')
class TransformerModelBN(FairseqEncoderDecoderModel):
    """
...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        self.layers.extend([
            TransformerEncoderLayerBN(args)
...
@register_model_architecture('transformer_bn', 'transformer_bn')
...
@register_model_architecture('transformer_bn', 'transformer_wmt_en_de_bn')
